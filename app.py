...
# 📌 1. Chọn video random từ playlist
...
# 📌 2. Download video (chỉ lấy 50 giây đầu)
...
# 📌 3. Xử lý text: chuyển thành lowercase, xóa dấu
...
# 📌 6. Xử lý video + gắn subtitles
def process_video(video_path, audio_path, brainrot_text, output_video="final_output.mp4"):
    ...
    # 📌 Gắn sub
    subtitle = TextClip(
        brainrot_text, fontsize=40, color="white", font="Arial-Bold",
        stroke_color="black", stroke_width=2, method="caption",
        size=(video.w - 100, None)  
    ).set_position(("center", "bottom")).set_duration(min_duration)
...
if pdf_file:
    ...
    if st.button("Generate Video"):
        ...
        if random_video_url:
            ...
            final_video = process_video(video_path, audio_path, brainrot_text, "final_output.mp4")
